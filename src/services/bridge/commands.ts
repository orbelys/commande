...
const LIBELLES: Record<CommandType, string> = {
  ...
  'projection.audio.lire': 'Lire la question',
  'projection.audio.pause': 'Mettre la voix en pause',
  'projection.audio.reprendre': 'Reprendre la lecture',
  ...
  'eleve.besoins': 'Relever les besoins d’un élève',
